...
public class SlideshowDialogFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        contType = getArguments().getString("type");
...
//        lblDate.setText(image.getTimestamp());
    ...
    public class MyViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            VideoView videoViewPreview = (VideoView) view.findViewById(R.id.video_preview);

            Image image = images.get(position);

            if (contType.equals("video")) {
                MediaController mediaController = new MediaController(getActivity());
                mediaController.setAnchorView(videoViewPreview);
                videoViewPreview.setMediaController(mediaController);
                videoViewPreview.setVideoURI(Uri.parse(image.getMedium()));
